...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    $get_hash = isset($_GET['h']) ? $_GET['h'] : "hash type not specified";
    $get_val = isset($_GET['v']) ? $_GET['v'] : "value not specified";

    if (!empty($get_hash) && !empty($get_val)) {
        // include_once "switch_hash.php";
        include_once "loop_hash.php";
    } else {
    ...
    <main class='form-signin'>
        <form method='get'>
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="inputselect" name="h" value="<?= $get_hash ?>">
