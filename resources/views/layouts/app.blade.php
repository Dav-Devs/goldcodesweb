...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <head>
        ...
        <link href="{{ asset('css/p-nav.css') }}" rel="stylesheet">
        <link href="{{ asset('dist/css/b-styling.css') }}" rel="stylesheet">
    </head>
    ...
    <body class="state-spinner-fixed">
        ...
        <nav class="navbar">
            <div class="mw">
                <div class="logo"><a href="#"><img src="/assets/img/logos/ddlogo.png" alt="DavDevs" width="40"
                            height="34">David's Devs</a></div>
                <ul class="menu">
                    <li><a href="#" class="menu-btn">Home</a></li>
                    <li><a href="#" class="menu-btn">Blog</a></li>
                    <li><a href="#" class="menu-btn">Log In</a></li>
                    <li><a href="#" class="menu-btn btn" style="border-radius: 5px;">Sign Up</a></li>
                </ul>
                <div class="menu-btn">
