        ...
        <div class="m-auto pt-4 pb-16 sm:m-auto w-4/5 block text-center">
            <div class="p-4 p-md-5 mb-4 text-white rounded bg-dark">
                <div class="col-md-6 px-0">
                    <h1 class="display-4 fst-italic">Welcome to DavDevs</h1>
                    <p class="lead my-3">Informing new readers quickly and efficiently about what’s most interesting in this Blog.</p>
                    <p class="lead mb-0"><a href="#" class="text-white fw-bold btn btn-outline-secondary">Continue reading...</a></p>
                </div>
            </div>
        </div>
    </div>
...
<div class="sm:grid grid-cols-2 gap-20 w-4/5 mx-auto py-15 border-b border-gray-200">
    <div>
        <img src="{{ asset('img/obj/o10.jpg') }}" width="700" alt="">
    </div>
    ...
    <div class="m-auto sm:m-auto text-left w-4/5 block">
        ...
        <a href="{{ url('/blog') }}" class="uppercase bg-blue-500 text-gray-100 text-s font-extrabold py-3 px-8 rounded-3xl">
            Find Out More
        </a>
    </div>
</div>
...
<div class="sm:grid grid-cols-2 w-4/5 m-auto">
    <div class="flex bg-yellow-700 text-gray-100 pt-10">
        <div class="m-auto pt-4 pb-16 sm:m-auto w-4/5 block">
            ...
            <a href="{{ url('/blog') }}" class="uppercase bg-transparent border-2 border-gray-100 text-gray-100 text-xs font-extrabold py-3 px-5 rounded-3xl">
                Find Out More
            </a>
        </div>
    </div>
    <div>
        <img src="{{ asset('img/obj/o15.jpg') }}" alt="">
    </div>
</div>
@endsection
