<nav class="navbar navbar-expand-md navbar-dark bg-dark" style="background: #fcf6e9" role="navigation" aria-label="navbar">
    <div class="container-fluid">
      ...
      <button class="navbar-toggler collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#b_navbar" aria-controls="b_navbar" aria-expanded="false" aria-label="Toggle navigation">
...
@guest
              ...
              <li class="nav-item">
                  <a class="nav-link btn btn-sm border rounded-pill r_btn" href="{{ route('register') }}">{{ __('Register') }}
                      <span>&raquo;</span></a>
              </li>
          </ul>
